package com.eumpyo.eum.common.exception;

import com.eumpyo.eum.common.code.ErrorCode;
import com.eumpyo.eum.common.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        final ErrorResponse response = ErrorResponse.of(ErrorCode.ARGUMENT_NOT_VALID_ERROR, String.valueOf(stringBuilder));
        return new ResponseEntity<>(response, HttpStatus.valueOf(ErrorCode.ARGUMENT_NOT_VALID_ERROR.getStatus()));
    }

    /**
     * [Exception] API 호출 시 'Header' 내에 데이터 값이 존재하지 않은 경우
     *
    ...
    protected ResponseEntity<ErrorResponse> handleMissingRequestHeaderException(MissingRequestHeaderException ex) {
        ...
        return new ResponseEntity<>(response, HttpStatus.valueOf(ErrorCode.MISSING_REQUEST_HEADER_ERROR.getStatus()));
    }
